...
TO_INST_PM = convert_xhtml2.pl \
	lib/HTML2XHTML/HTML2XHTML.pm \
	lib/HTML2XHTML/HTML2XHTML.pod \
	lib/HTML2XHTML/convert_xhtml2.pl

PM_TO_BLIB = convert_xhtml2.pl \
	$(INST_LIB)\convert_xhtml2.pl \
	lib/HTML2XHTML/HTML2XHTML.pm \
	blib\lib\HTML2XHTML\HTML2XHTML.pm \
	lib/HTML2XHTML/HTML2XHTML.pod \
	blib\lib\HTML2XHTML\HTML2XHTML.pod \
	lib/HTML2XHTML/convert_xhtml2.pl \
	blib\lib\HTML2XHTML\convert_xhtml2.pl
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib\lib\HTML2XHTML\HTML2XHTML.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE) blib\lib\HTML2XHTML\convert_xhtml2.pl blib\lib\HTML2XHTML\HTML2XHTML.pod $(INST_LIB)\convert_xhtml2.pl
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e "pm_to_blib({@ARGV}, '$(INST_LIB)\auto', '$(PM_FILTER)')"\
	  convert_xhtml2.pl $(INST_LIB)\convert_xhtml2.pl \
	  ...
	  lib/HTML2XHTML/convert_xhtml2.pl blib\lib\HTML2XHTML\convert_xhtml2.pl 
	$(NOECHO) $(TOUCH) $@
