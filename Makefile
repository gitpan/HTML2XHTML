# This Makefile is for the HTML2XHTML extension to perl.
#
...
#     NAME => q[HTML2XHTML]
#     PREREQ_PM => { File::Flock=>q[104.111901], Cwd=>q[3.05] }
#     VERSION_FROM => q[lib/HTML2XHTML/HTML2XHTML.pm]
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/HTML2XHTML/HTML2XHTML.pod
...
TO_INST_PM = lib/HTML2XHTML/HTML2XHTML.pm \
	lib/HTML2XHTML/HTML2XHTML.pod \
	lib/HTML2XHTML/convert_xhtml.pl

PM_TO_BLIB = lib/HTML2XHTML/convert_xhtml.pl \
	blib\lib\HTML2XHTML\convert_xhtml.pl \
	lib/HTML2XHTML/HTML2XHTML.pm \
	blib\lib\HTML2XHTML\HTML2XHTML.pm \
	lib/HTML2XHTML/HTML2XHTML.pod \
	blib\lib\HTML2XHTML\HTML2XHTML.pod
...
HTML2XHTML.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"HTML2XHTML\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW)\
	  lib/HTML2XHTML/HTML2XHTML.pod $(INST_MAN3DIR)\HTML2XHTML.HTML2XHTML.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib\lib\HTML2XHTML\HTML2XHTML.pm blib\lib\HTML2XHTML\convert_xhtml.pl $(MAKEFILE_OLD) $(FIRST_MAKEFILE) blib\lib\HTML2XHTML\HTML2XHTML.pod
...
metafile :
	...
	$(NOECHO) $(ECHO) "name:         HTML2XHTML" >> META.yml
	$(NOECHO) $(ECHO) "version:      0.04" >> META.yml
	$(NOECHO) $(ECHO) "version_from: lib/HTML2XHTML/HTML2XHTML.pm" >> META.yml
	$(NOECHO) $(ECHO) "installdirs:  site" >> META.yml
	$(NOECHO) $(ECHO) "requires:" >> META.yml
	$(NOECHO) $(ECHO) "    Cwd:                           3.05" >> META.yml
	$(NOECHO) $(ECHO) "    File::Flock:                   104.111901" >> META.yml
...
TEST_FILE = test.pl
TEST_FILES = t\convert_css_file.t t\convert_css_html_file.t t\convert_current_directory.t t\convert_html_file.t
TESTDB_SW = -d
...
ppd:
	...
	$(NOECHO) $(ECHO) "        <DEPENDENCY NAME=\"Cwd\" VERSION=\"3,05,0,0\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <DEPENDENCY NAME=\"File-Flock\" VERSION=\"104,111901,0,0\" />" >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e "pm_to_blib({@ARGV}, '$(INST_LIB)\auto', '$(PM_FILTER)')"\
	  lib/HTML2XHTML/convert_xhtml.pl blib\lib\HTML2XHTML\convert_xhtml.pl \
	  lib/HTML2XHTML/HTML2XHTML.pm blib\lib\HTML2XHTML\HTML2XHTML.pm \
	  lib/HTML2XHTML/HTML2XHTML.pod blib\lib\HTML2XHTML\HTML2XHTML.pod 
	$(NOECHO) $(TOUCH) $@
